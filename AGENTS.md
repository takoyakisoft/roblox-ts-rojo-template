...
- **Mocks**:
    - `tests/roblox_mocks.luau` is **auto-generated**. **DO NOT EDIT THIS FILE DIRECTLY.**
    - If you need to modify the mock behavior, update the generator script: `tests/command/generate_mocks_studio.luau`.
